<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM data_pilihan WHERE id ='$id'") or die ("SQL Edit error");
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="kode" value="<?=$data['kode']?>"class="form-control" id="inputEmail3" placeholder="Para Pihak">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="mata" class="col-sm-3 control-label">Pelajaran</label>
                            <div class="col-sm-9">
                                <input type="text" name="mata" value="<?=$data['mata']?>"class="form-control" id="inputEmail3" placeholder="Para Pihak">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="guru" class="col-sm-3 control-label">Guru</label>
                            <div class="col-sm-9">
                                <input type="text" name="guru" value="<?=$data['guru']?>"class="form-control" id="inputEmail3" placeholder="Para Pihak">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success" id="uud">
...
if($_POST){
    ...
    $guru=$_POST['guru'];
    //buat sql
    $sql="UPDATE data_pilihan SET nip='$nip_s',nama='$nama_s',jk='$jenis_s',alamat='$alamat_s',kode='$kode',mata='$mata',guru='$guru' WHERE id ='$id'"; 
