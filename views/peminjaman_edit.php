                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <label for="pelajaran" class="col-sm-3 control-label">Pengajar</label>
                            <div class="col-sm-9">
                                <input type="text" name="pengajar" value="<?=$data['Pengajar']?>"class="form-control" id="inputEmail3" placeholder="Nama Peminjam">
                            </div>
                        </div>
                         <div class="form-group">
...
if($_POST){
   ...
   // $ket=$_POST['ket'];
    ...
    $sql="UPDATE data_pelajaran SET kode = '$kode', pelajaran ='$pelajaran', Pengajar='$pengajar' WHERE id='$id'"; 
